...
public abstract class Gate{
	...
	public static enum Type {And,Or,Not,Nand,Nor,Xor};
	...
	/**
	 * Factory method that makes it easy to construct gates
	 * when we have the type in the appropriate enum.
	 * @param type The type of the gate to be created 
	 * */
